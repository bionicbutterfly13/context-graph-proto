...
class Neo4jContextGraph:
    ...
    def add_triplet_with_context(self, edge: ContextEdge, chunk_ids: List[str] = None):
        """Adds a reified triplet node to support rich context and chunk linkage."""
        cypher = """
        ...
        SET tr.temporal = $temporal,
            tr.geographic = $geographic,
        ...
        params = {
            ...
            "temporal": json.dumps(edge.context.temporal),
            "geographic": edge.context.geographic,
            "confidence": edge.context.confidence,
            "provenance": edge.context.provenance
        }
        self.query(cypher, params)
